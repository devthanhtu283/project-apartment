            ...
            <div class="card-body">
                <form method="post" action="${pageContext.request.contextPath}/postapartment" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="inputUsername" step="0.1" name="price" min="1" type="number" placeholder="Nhập giá" required>
                  </div>
                  <div class="mb-3">
                      <label class="small mb-1" for="inputUsername">Đặt cọc (triệu đồng)</label>
                      <input class="form-control" id="inputUsername" step="0.1" name="deposit" type="number" min="1" placeholder="Nhập giá" required>
                  </div>
